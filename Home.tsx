...
.login-container {
  ...
  gap: 2rem;
        ...
        .form-title h2 {
          font-size: 2.2rem; color: white; font-weight: 800;
          text-transform: uppercase; margin-bottom: 0.5rem;
          text-align: center;
        }

        .form-title p {
          color: rgba(255, 255, 255, 0.8); text-align: center; margin-bottom: 2rem;
        }

        .form-label {
          display: block; color: #FFD400; font-weight: 700;
          text-transform: uppercase; margin-bottom: 0.5rem; font-size: 0.9rem;
        }
        ...
        .form-input:focus {
          outline: none; border-color: #FFD400;
          background: rgba(255, 255, 255, 0.25);
        }

        .submit-btn {
          width: 100%; padding: 1.2rem;
          background: #FFD400; color: #19287F;
        ...
        .login-footer {
          position: fixed; bottom: 2rem; color: rgba(255,255,255,0.7);
